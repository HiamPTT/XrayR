...
read -p "Nhập Domain 443:" CertDomain
  ...
  #Cloudflare
  read -p "Nhập Cloudflare_mail 443:" mail
  [ -z "${mail}" ] && mail="0"
  echo "-------------------------------"
  echo -e "CLOUDFLARE_EMAIL là: ${mail}"
  echo "-------------------------------"
  
  read -p "Nhập Cloudflare_key 443:" key
  [ -z "${key}" ] && key="0"
  echo "-------------------------------"
  echo -e "CLOUDFLARE_KEY là: ${key}"
  echo "-------------------------------"
